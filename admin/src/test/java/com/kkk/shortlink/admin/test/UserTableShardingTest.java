package com.kkk.shortlink.admin.test;
...
public class UserTableShardingTest {
    ...
    public static final String SQL = "CREATE TABLE `t_link_%d` (\n" +
            ...
            "  `full_short_url` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '完善短链接',\n" +
            ...
            "  `valid_date_type` tinyint(1) DEFAULT NULL COMMENT '有效期类型 0永久有效 1自定义有效期',\n" +
            ...
            "  PRIMARY KEY (`id`),\n" +
            "  KEY `ide_unique_full_short_url` (`full_short_url`) USING BTREE\n" +
            ") ENGINE=InnoDB AUTO_INCREMENT=1972198121188306947 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;";

package com.kkk.shortlink.admin.common.biz.user;
...
import static com.kkk.shortlink.admin.common.enums.UserErrorCodeEnum.USER_TOKEN_FAIL;
...
public class UserTransmitFilter implements Filter {
    ...
    public static final List<String> IGNORE_URI = Lists.newArrayList(
            ...
            "/api/short-link/admin/v1/user/has-username" // 查询用户名是否存在
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if (!IGNORE_URI.contains(requestURI)){//忽略了
